    ...
    <div className="fixed bottom-0 inset-x-0 z-50 bg-gray-900 text-white shadow-2xl border-t border-gray-700">
      <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <p className="text-sm leading-6 text-gray-200">
          We use essential cookies to keep CFCT Management System secure and
          reliable. Read our
          <Link
            to="/privacy"
            className="underline ml-1 mr-1 text-blue-300 hover:text-blue-200"
          >
            Privacy Policy
          </Link>
          and
          <Link
            to="/terms"
            className="underline ml-1 text-blue-300 hover:text-blue-200"
          >
            Terms of Service
          </Link>
          .
