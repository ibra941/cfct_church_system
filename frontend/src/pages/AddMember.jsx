...
// Plain axios instance with NO auth token — used for public hierarchy lookups
// (zones/regions/districts/locals filter by leader scope when token is present)
const API_BASE_URL =
...
const AddMember = () => {
  ...
  const fetchZones = async () => {
    ...
    try {
      const res = await publicApi.get("/zones/");
        ...
        <form onSubmit={handleSubmit}>
          ...
          {step === 3 && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                {language === "sw"
                  ? "Taarifa za Kiroho & Kanisa"
                  : "Spiritual Info & Church"}
              </h3>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                  {language === "sw"
                    ? "Chagua Kanisa la Mwanachama"
                    : "Select Member's Church"}
                </p>
