...
const Churches = () => {
  ...
  const showRegionFilter = effectiveScope === "national" || effectiveScope === "zone";
  const showDistrictFilter =
    effectiveScope === "national" || effectiveScope === "zone" || effectiveScope === "regional";
  ...
  useEffect(() => {
    fetchChurches();
  }, [search, filters.zoneId, filters.regionId, filters.districtId, currentPage]);
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          <input
            ...
            className="input"
            placeholder={
              language === "sw" ? "Tafuta kanisa kwa jina" : "Search church by name"
            }
            value={search}
            onChange={(e) => {
              setCurrentPage(1);
