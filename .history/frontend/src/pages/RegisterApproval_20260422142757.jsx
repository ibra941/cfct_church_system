...
const RegisterApproval = () => {
  ...
  const fetchRegistrations = async () => {
    ...
    try {
      ...
      console.log("API Response - Full response:", response.data);
      console.log("API Response - Data to display:", data);
      if (Array.isArray(data) && data.length > 0) {
        console.log("First registration:", data[0]);
        console.log("First registration personal_info:", data[0].personal_info);
        console.log("First registration guardian_info:", data[0].guardian_info);
        console.log(
          "First registration spiritual_info:",
          data[0].spiritual_info,
        );
      }
  ...
  const viewDetails = (registration) => {
    ...
    console.log("Personal info:", registration.personal_info);
    console.log("Guardian info:", registration.guardian_info);
    console.log("Spiritual info:", registration.spiritual_info);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-3xl w-full max-h-screen overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              {/* Debug Info */}
              <div className="p-3 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded text-xs">
                <p className="text-blue-900 dark:text-blue-100">
                  <strong>DEBUG:</strong> personal_info keys: {selectedRegistration.personal_info ? Object.keys(selectedRegistration.personal_info).join(", ") : "null"}
                </p>
                <p className="text-blue-900 dark:text-blue-100">
                  guardian_info keys: {selectedRegistration.guardian_info ? Object.keys(selectedRegistration.guardian_info).join(", ") : "null"}
                </p>
                <p className="text-blue-900 dark:text-blue-100">
                  spiritual_info keys: {selectedRegistration.spiritual_info ? Object.keys(selectedRegistration.spiritual_info).join(", ") : "null"}
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  {selectedRegistration.personal_info && Object.keys(selectedRegistration.personal_info).length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  {selectedRegistration.guardian_info && Object.keys(selectedRegistration.guardian_info).length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  {selectedRegistration.spiritual_info && Object.keys(selectedRegistration.spiritual_info).length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
