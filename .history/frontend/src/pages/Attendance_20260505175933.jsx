          ...
          <div>
            ...
            >
              ...
              <option value="sunday_service">
                {language === "sw" ? "Ibada ya Jumapili" : "Sunday Service"}
              </option>
              <option value="midweek">
                {language === "sw"
                  ? "Ibada ya Kati ya Wiki"
                  : "Midweek Service"}
              </option>
              <option value="prayer_meeting">
                {language === "sw" ? "Mkutano wa Maombi" : "Prayer Meeting"}
              </option>
              <option value="bible_study">
                {language === "sw" ? "Masomo ya Biblia" : "Bible Study"}
              </option>
              <option value="special_event">
                {language === "sw" ? "Tukio Maalum" : "Special Event"}
              </option>
              <option value="small_group">
                {language === "sw" ? "Kikundi Kidogo" : "Small Group"}
              </option>
            </select>
          </div>
          <button
