  ...
  const fetchRegistrations = async () => {
    ...
    try {
      ...
      if (Array.isArray(data) && data.length > 0) {
        ...
        console.log("First registration spiritual_info:", data[0].spiritual_info);
      }
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {(!selectedRegistration.personal_info ||
                      Object.values(selectedRegistration.personal_info).every(
                        (v) =>
                          v === null ||
                          v === undefined ||
                          v === "" ||
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {(!selectedRegistration.guardian_info ||
                      Object.values(selectedRegistration.guardian_info).every(
                        (v) =>
                          v === null ||
                          v === undefined ||
                          v === "" ||
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {(!selectedRegistration.spiritual_info ||
                      Object.values(selectedRegistration.spiritual_info).every(
                        (v) =>
                          v === null ||
                          v === undefined ||
                          v === "" ||
