    ...
    try {
      ...
      setPotentialLeaders(
        users.filter((item) => {
          ...
          return ["local_leader", "district_leader", "regional_leader", "zone_leader", "national_leader"].includes(item.role);
        }),
      );
    } catch (error) {
      console.error(error);
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        {canManageDepartments && (
          ...
          >
            <FaPlus />
            <span>
              {language === "sw" ? "Ongeza Idara" : "Add Department"}
            </span>
          </button>
        )}
      </div>
          ...
          >
            ...
            {(dept.leader_phone || dept.leader_email) && (
              <p className="text-xs text-gray-500 dark:text-gray-400">
                {language === "sw" ? "Mawasiliano" : "Contact"}: {dept.leader_phone || "-"}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4 max-h-screen overflow-y-auto">
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    {language === "sw" ? "Kiongozi wa Idara" : "Department Leader"}
                  </label>
                  <select
                    className="input"
