...
const AuditLogs = () => {
  ...
  const allSelected = logs.length > 0 && logs.every((log) => selectedLogIds.includes(log.id));
              ...
              <tr>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                  <input
                    ...
                    aria-label={language === "sw" ? "Chagua zote" : "Select all logs"}
                  />
                </th>
                ...
                <tr key={log.id}>
                  <td className="px-4 py-4 align-top">
                    <input
                      ...
                      aria-label={language === "sw" ? `Chagua rekodi ${log.id}` : `Select log ${log.id}`}
                    />
                  </td>
