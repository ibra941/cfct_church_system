  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        activities_summary: (formData.activities_summary || "").trim(),
        ...
        {departments.map((dept) => (
          ...
          >
                  ...
                  <button
                    onClick={() => {
                      ...
                      setFormData({
                        ...
                        activities_summary: dept.activities_summary || "",
                      });
                      setShowModal(true);
                    }}
            ...
            <div className="mt-4 flex items-center justify-between">
              {isLocalMember ? (
                <span className="inline-block px-3 py-1 rounded-full text-xs bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-200 capitalize">
                  {getRequestStatus(dept) === "not_applied"
                    ? language === "sw"
                      ? "Bado hujaomba"
                      : "Not applied"
                    : getRequestStatus(dept)}
                </span>
              ) : (
                <span className="text-xs text-gray-500 dark:text-gray-400">
                  {language === "sw"
                    ? "Bofya kufungua idara"
                    : "Click to open department"}
                </span>
              )}
              <Link to={`/departments/${dept.id}`} className="btn-primary text-xs">
                {language === "sw" ? "Fungua Idara" : "Open Department"}
              </Link>
            </div>
          </div>
        ))}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        activities_summary: e.target.value,
                      })
                    }
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, policies: e.target.value })
                    }
                  />
                </div>
                <div>
