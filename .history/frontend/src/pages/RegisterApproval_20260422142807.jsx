            ...
            <div className="p-6 space-y-6">
              ...
              <div className="p-3 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded text-xs">
                <p className="text-blue-900 dark:text-blue-100">
                  <strong>DEBUG:</strong> personal_info keys:{" "}
                  {selectedRegistration.personal_info
                    ? Object.keys(selectedRegistration.personal_info).join(", ")
                    : "null"}
                </p>
                <p className="text-blue-900 dark:text-blue-100">
                  guardian_info keys:{" "}
                  {selectedRegistration.guardian_info
                    ? Object.keys(selectedRegistration.guardian_info).join(", ")
                    : "null"}
                </p>
                <p className="text-blue-900 dark:text-blue-100">
                  spiritual_info keys:{" "}
                  {selectedRegistration.spiritual_info
                    ? Object.keys(selectedRegistration.spiritual_info).join(
                        ", ",
                      )
                    : "null"}
                </p>
