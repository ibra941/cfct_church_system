...
const ChurchDirectory = () => {
  ...
  const fetchDirectory = async () => {
    ...
    try {
      ...
      toast.error(t("Imeshindikana kupata orodha ya wanachama", "Failed to load church directory"));
      setMembers([]);
    } finally {
      setLoading(false);
    }
    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder={t("Tafuta jina, mtaa au simu...", "Search name, area or phone...")}
          value={search}
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {filtered.length === 0 && (
          <div className="col-span-full text-center py-12 text-gray-500 dark:text-gray-400">
            {t("Hakuna wanachama wanaolingana na utafutaji wako.", "No members match your search.")}
          </div>
        )}
      </div>
    </div>
