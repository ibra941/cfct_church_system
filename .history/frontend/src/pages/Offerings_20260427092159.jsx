...
const Offerings = () => {
  ...
  const fetchSummary = async () => {
    try {
      // Calculate summary from current offerings
      const typeMap = {
        tithe: language === "sw" ? "Zaka" : "Tithes",
        offering: language === "sw" ? "Sadaka" : "Offerings",
        building: language === "sw" ? "Mchango wa Jengo" : "Building Fund",
        mission: language === "sw" ? "Mchango wa Misheni" : "Mission",
      };

      const byType = {};
      offerings.forEach((o) => {
        const key = o.offering_type || "offering";
        byType[key] = (byType[key] || 0) + parseFloat(o.amount || 0);
      });
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">
              {language === "sw" ? "Ushindi wa Matoleo" : "Offerings Summary"}
            </h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              ...
              <option value="building">
                {language === "sw" ? "Mchango wa Jengo" : "Building Fund"}
              </option>
              <option value="mission">
                {language === "sw" ? "Mchango wa Misheni" : "Mission"}
              </option>
            </select>
            ...
            >
              <option value="cash">
                {language === "sw" ? "Fedha Taslimu" : "Cash"}
              </option>
              <option value="mobile_money">
                {language === "sw" ? "Simu Pesa" : "Mobile Money"}
              </option>
              <option value="bank_transfer">
                {language === "sw" ? "Benki" : "Bank Transfer"}
              </option>
              <option value="online">
                {language === "sw" ? "Mtandaoni" : "Online"}
              </option>
              <option value="cheque">
                {language === "sw" ? "Hundi" : "Cheque"}
              </option>
            </select>
            ...
            {offerings.slice(0, 10).map((offering) => (
              ...
              >
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  {getOfferingTypeLabel(offering.offering_type || "offering")} -{" "}
                  {offering.payment_method}
                </div>
                {isLeader && offering.member_name && (
