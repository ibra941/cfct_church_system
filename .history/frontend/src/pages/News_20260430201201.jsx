...
const News = () => {
  ...
  const resetForm = () => {
    setEditingNews(null);
    setFormData(NEWS_FORM_INITIAL_STATE);
              ...
              <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    title={language === "sw" ? "Tazama habari" : "View news"}
                    aria-label={language === "sw" ? "Tazama habari" : "View news"}
                  >
                    <FaEye />
                  </button>
                    ...
                    <>
                      <button
                        onClick={() => {
                          ...
                          setSelectedImage(item.featured_image || null);
                          setShowModal(true);
                        }}
              ...
              <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 dark:text-gray-400 mb-4">
                <span className="inline-flex items-center gap-1">
                  ...
                  {selectedNews.created_at
                    ? format(new Date(selectedNews.created_at), "dd/MM/yyyy")
                    : "-"}
                </span>
                <span
                  className={`px-2 py-1 text-xs rounded-full ${
