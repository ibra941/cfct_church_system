...
const Sidebar = () => {
  ...
  const getRoleLabel = (role) => {
    const labels = {
      national_leader: language === "sw" ? "Kiongozi wa Taifa" : "National Leader",
      zone_leader: language === "sw" ? "Kiongozi wa Kanda" : "Zone Leader",
      regional_leader: language === "sw" ? "Kiongozi wa Mkoa" : "Regional Leader",
      district_leader: language === "sw" ? "Kiongozi wa Wilaya" : "District Leader",
