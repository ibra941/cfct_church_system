...
const Sidebar = () => {
  ...
  const getRoleLabel = (role) => {
    const labels = {
      national_leader:
        language === "sw" ? "Kiongozi wa Taifa" : "National Leader",
      zone_leader: language === "sw" ? "Kiongozi wa Kanda" : "Zone Leader",
      regional_leader:
        language === "sw" ? "Kiongozi wa Mkoa" : "Regional Leader",
      district_leader:
        language === "sw" ? "Kiongozi wa Wilaya" : "District Leader",
      local_leader: language === "sw" ? "Mchungaji" : "Pastor",
      local_member: language === "sw" ? "Mwanachama" : "Member",
      finance_team: language === "sw" ? "Timu ya Fedha" : "Finance Team",
    };

    return labels[role] || (language === "sw" ? "Mwanachama" : "Member");
  };
  ...
  const menuItems = [
...

    {
      path: "/giving-history",
      icon: <FaHistory />,
      label: language === "sw" ? "Historia ya Matoleo" : "Giving History",
      roles: ["local_member", "local_leader"],
    },

    {
      path: "/attendance",
      icon: <FaQrcode />,
      label: language === "sw" ? "Mahudhurio" : "Attendance",
      roles: ["local_member", "local_leader"],
    },

    {
      ...
      icon: <FaChartLine />,
      label: language === "sw" ? "Usimamizi wa Fedha" : "Financial Oversight",
      roles: ["local_leader"],
    },

    {
      path: "/pastoral-care",
      icon: <FaPray />,
      label: language === "sw" ? "Huduma ya Kichungaji" : "Pastoral Care",
      roles: ["local_leader"],
    },

    {
      ...
      icon: <FaCalendarAlt />,
      label: language === "sw" ? "Mipango ya Ibada" : "Services Planning",
      roles: ["local_leader"],
    },
    ...
    // Member Transfers
    {
      ...
      roles: ["national_leader", "zone_leader", "regional_leader", "local_leader"],
    },
    ...
    // Prayer Requests
    {
      path: "/prayers",
      icon: <FaPray />,
      label: language === "sw" ? "Maombi" : "Prayer Requests",
      roles: ["local_member", "local_leader"],
    },
    ...
    // Church Directory
    {
      ...
      icon: <FaAddressBook />,
      label: language === "sw" ? "Orodha ya Kanisa" : "Church Directory",
      roles: ["local_member", "local_leader"],
    },
    ...
    // Sermon Archive
    {
      path: "/sermon-archive",
      icon: <FaBook />,
      label: language === "sw" ? "Kumbukumbu ya Mahubiri" : "Sermon Archive",
      roles: ["local_member", "local_leader"],
    },
