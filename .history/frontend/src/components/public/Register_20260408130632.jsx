                ...
                <div>
                  ...
                  >
                    <option value="teaching">
                      {language === "sw" ? "Kufundisha" : "Teaching"}
                    </option>
                    <option value="preaching">
                      {language === "sw" ? "Kuhubiri" : "Preaching"}
                    </option>
                    <option value="music">
                      {language === "sw" ? "Muziki" : "Music"}
                    </option>
                    <option value="worship">
                      {language === "sw" ? "Ibada" : "Worship"}
                    </option>
                    <option value="prayer">
                      {language === "sw" ? "Maombi" : "Prayer"}
                    </option>
                    <option value="evangelism">
                      {language === "sw" ? "Uinjilisti" : "Evangelism"}
                    </option>
                    <option value="leadership">
                      {language === "sw" ? "Uongozi" : "Leadership"}
                    </option>
                    <option value="service">
                      {language === "sw" ? "Huduma" : "Service"}
                    </option>
                    <option value="administration">
                      {language === "sw" ? "Utawala" : "Administration"}
                    </option>
                    <option value="other">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {language === "sw"
                      ? "Bonyeza Ctrl (Cmd kwenye Mac) ili kuchagua zaidi ya moja"
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="outreach">
                      {language === "sw" ? "Uenezi" : "Outreach"}
                    </option>
                    <option value="counseling">
                      {language === "sw" ? "Ushauri" : "Counseling"}
                    </option>
                    <option value="missions">
                      {language === "sw" ? "Misioni" : "Missions"}
                    </option>
                    <option value="administration">
                      {language === "sw" ? "Utawala" : "Administration"}
                    </option>
                    <option value="technical">
                      {language === "sw" ? "Kiufundi" : "Technical"}
                    </option>
                    <option value="media">
                      {language === "sw" ? "Vyombo vya Habari" : "Media"}
                    </option>
                    <option value="other">
                      {language === "sw" ? "Nyingine" : "Other"}
                    </option>
