...
const Contact = () => {
  ...
  const addressValue =
    contactMap.address || "HEAD QUOTER. GEITA MJINI -NSHINDE";
  const serviceTimesValue =
    contactMap.service_times ||
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div className="min-w-0">
                ...
                <p className="text-gray-600 dark:text-gray-300 break-words">{phoneValue}</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div className="min-w-0">
                ...
                <p className="text-gray-600 dark:text-gray-300 break-all">{emailValue}</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
