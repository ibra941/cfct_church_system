...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <div
        className="relative min-h-[85vh] md:min-h-screen bg-cover bg-center md:bg-fixed"
        style={{
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full text-white text-center px-4 sm:px-6">
          <img
            src={heroLogo}
            alt="CFCT Logo"
            className="w-20 h-20 sm:w-24 sm:h-24 mb-6 animate-bounce"
          />
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold mb-4 break-words max-w-5xl">
            {heroTitle}
          </h1>
          <p className="text-base sm:text-xl md:text-2xl mb-8 max-w-2xl break-words">
            {heroSubtitle}
          </p>
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            <Link to="/register" className="btn-primary text-base sm:text-lg px-6 sm:px-8 py-3">
              {language === "sw" ? "Jiunge Nasi" : "Join Us"}
            </Link>
            <a href="#history" className="btn-secondary text-base sm:text-lg px-6 sm:px-8 py-3">
