  ...
  const submitTransferRequest = async () => {
    ...
    try {
      ...
      if (transferForm.recommendation_letter) {
        payload.append("recommendation_letter", transferForm.recommendation_letter);
      }
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <select
              ...
              onChange={(e) =>
                setTransferForm((prev) => ({ ...prev, to_church: e.target.value }))
              }
            >
              <option value="">
                {language === "sw" ? "Chagua Kanisa Lengwa" : "Select Destination Church"}
              </option>
          ...
          >
            {language === "sw" ? "Tuma Ombi la Uhamisho" : "Submit Transfer Request"}
          </button>
            ...
            {transferRequests.map((request) => (
              ...
              >
                <p className="text-sm font-medium text-gray-900 dark:text-white">
                  {request.from_church_name} {language === "sw" ? "kwenda" : "to"}{" "}
                  {request.to_church_name}
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                ...
                {request.recommendation_letter_url && (
                  ...
                  >
                    {language === "sw" ? "Fungua Barua ya Uhamisho" : "Open Transfer Letter"}
                  </a>
                )}
                {request.notes && (
