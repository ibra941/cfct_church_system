...
const ZoneDashboard = () => {
  ...
  return (
    <div>
      {/* Navigation Buttons - Zone can go down to Region and District */}
      <div className="mb-6 flex items-center justify-between">
        <div className="flex space-x-3">
          ...
          >
            <FaArrowRight />
            <span>{language === "sw" ? "Kwa Mikoa" : "To Regions"}</span>
          </Link>
          <Link
        ...
        <div className="text-sm text-gray-500 dark:text-gray-400">
          ...
          {" → "}
          <span className="text-gray-400">Mkoa → Wilaya → Kanisa</span>
        </div>
      </div>
