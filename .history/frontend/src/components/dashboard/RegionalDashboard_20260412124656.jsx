...
const RegionalDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const statsUrl = regionId ? `/dashboard/stats/?church_id=${regionId}` : "/dashboard/stats/";
      ...
      const districtsUrl = regionId ? `/districts/?parent_id=${regionId}` : "/districts/";
      ...
      try {
        ...
        setOfferingChartData(offeringTypeResponse.data || generateOfferingTypeData());
      } catch (e) {
