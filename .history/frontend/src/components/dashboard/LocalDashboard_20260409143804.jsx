        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              {language === "sw" ? "Dashibodi ya Kanisa Lokal" : "Local Church Dashboard"}
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mt-1">
              {user?.church?.name || (language === "sw" ? "Kanisa Lako Lokal" : "Your Local Church")}
            </p>
          </div>
            ...
            <LineChart data={chartData}>
              ...
              <Tooltip
                formatter={(value, name) => [
                  ...
                  name === 'offerings' ? (language === "sw" ? "Sadaka" : "Offerings") :
                  name === 'members' ? (language === "sw" ? "Wanachama" : "Members") :
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={chartData}>
              ...
              <YAxis />
              <Tooltip
                formatter={(value) => [value, language === "sw" ? "Wanachama" : "Members"]}
              />
            ...
            {recentPrayers.length > 0 ? (
              recentPrayers.map((prayer) => (
                <div key={prayer.id} className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-gray-900 dark:text-white truncate">
                      {prayer.title || (language === "sw" ? "Ombi la sala" : "Prayer request")}
                    </p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                {language === "sw" ? "Hakuna maombi ya sala" : "No prayer requests"}
              </p>
            )}
          </div>
        </div>
