...
const NationalDashboard = () => {
  ...
  return (
    <div>
      {/* Navigation Buttons - National can go down to all levels */}
      <div className="mb-6 flex items-center justify-between">
        <div className="flex space-x-3">
          ...
          >
            <FaArrowRight />
            <span>{language === "sw" ? "Kwa Kanda" : "To Zones"}</span>
          </Link>
          <Link
        ...
        <div className="text-sm text-gray-500 dark:text-gray-400">
          <span className="bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300 px-3 py-1 rounded-full">
            {language === "sw" ? "Taifa" : "National"}
          </span>
          {" → "}
          <span className="text-gray-400">Kanda → Mkoa → Wilaya → Kanisa</span>
        </div>
      </div>
