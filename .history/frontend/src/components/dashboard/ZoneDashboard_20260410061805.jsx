...
const ZoneDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      // Fetch region and district data for search
  ...
  return (
    <div>
      {/* Search and discovery for zone leadership */}
      <div className="grid gap-4 mb-6 lg:grid-cols-2">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {language === "sw"
                ? "Tafuta mikoa ndani ya kanda yako"
                : "Search regions within your zone"}
            </p>
          </div>
          <input
            type="text"
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {language === "sw"
                ? "Tafuta wilaya ndani ya kanda yako"
                : "Search districts within your zone"}
            </p>
          </div>
          <input
            type="text"
