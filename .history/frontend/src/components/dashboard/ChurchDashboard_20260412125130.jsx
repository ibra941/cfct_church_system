...
const ChurchDashboard = () => {
  ...
  const fetchChurchData = async () => {
    ...
    try {
      ...
      const statsResponse = await api.get(`/dashboard/stats/?church_id=${churchId}`);
      setStats({
  ...
  if (!churchId) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-500">{language === "sw" ? "Hakuna kanisa lililochaguliwa" : "No church selected"}</p>
      </div>
    );
  }
  ...
  return (
    <div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white">
              {churchInfo?.name || (language === "sw" ? "Dashibodi ya Kanisa" : "Church Dashboard")}
            </h1>
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              {churchInfo?.location
                ...
                : "All information for this local church"}
            </p>
          </div>
        </div>
      </div>
              ...
              <div>
                ...
                <div className="flex items-center mt-2">
                  ...
                  <span className="text-xs text-gray-400 ml-1">
                    {language === "sw" ? "kutoka mwezi uliopita" : "from last month"}
                  </span>
                </div>
              </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">
            {language === "sw" ? "Mahudhurio ya Kila Mwezi" : "Monthly Attendance"}
          </h2>
          <ResponsiveContainer width="100%" height={280}>
          ...
          <div className="space-y-3">
            ...
            {recentMembers.length === 0 && (
              <p className="text-gray-500 text-center py-4">
                {language === "sw" ? "Hakuna wanachama wapya" : "No recent members"}
              </p>
            )}
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="space-y-3">
            ...
            {recentEvents.length === 0 && (
              <p className="text-gray-500 text-center py-4">
                {language === "sw" ? "Hakuna matukio yajayo" : "No upcoming events"}
              </p>
            )}
          </div>
        </div>
      ...
      {recentPrayers.length > 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/prayers" className="text-sm text-primary-600 hover:text-primary-700">
              {language === "sw" ? "Tazama Zote" : "View All"} →
            </Link>
          </div>
          <div className="space-y-3">
