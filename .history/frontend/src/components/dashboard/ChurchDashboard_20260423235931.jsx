            ...
            {pendingDepartmentRequests.map((request) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  {language === "sw" ? "Idara" : "Department"}: {request.department_name}
                </p>
                ...
                <div className="flex gap-2 mt-3">
                  <button
                    type="button"
                    onClick={() => reviewDepartmentRequest(request.id, "approve")}
                  ...
                  <button
                    type="button"
                    onClick={() => reviewDepartmentRequest(request.id, "reject")}
                    disabled={reviewingRequestId === request.id}
