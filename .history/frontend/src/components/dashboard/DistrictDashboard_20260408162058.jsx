  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      setStats({
        ...
        monthlyGrowth: statsResponse.data.monthly_growth || 8,
        weeklyAttendance: statsResponse.data.weekly_attendance || 320,
        prayerRequests: statsResponse.data.prayer_requests || 5,
      });
    ...
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex space-x-3">
          ...
          >
            <FaArrowLeft />
            <span>{language === "sw" ? "Kwa Mkoa" : "To Region"}</span>
          </Link>
        </div>
        <div className="text-sm text-gray-500 dark:text-gray-400">
          ...
          {" → "}
          <span className="text-gray-400">Kanisa</span>
        </div>
      </div>
