...
class DashboardStatsView(APIView):
    ...
    def get(self, request):
        ...
        def queryset_scope(churches_queryset=None):
            if churches_queryset is None:
                return None
            if hasattr(churches_queryset, 'values_list'):
                return churches_queryset
            return Church.objects.filter(id__in=[church.id for church in churches_queryset])
