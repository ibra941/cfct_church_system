...
class EventViewSet(viewsets.ModelViewSet):
    ...
    def register(self, request, pk=None):
        ...
        if not user.church or event.church_id != user.church_id:
            return Response({'error': 'You can only register for events in your church.'}, status=status.HTTP_403_FORBIDDEN)
