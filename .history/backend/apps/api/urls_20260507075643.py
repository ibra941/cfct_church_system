...
urlpatterns = [
    ...
    path('health/live/', views.LiveHealthCheckView.as_view(), name='health_live'),
    path('health/ready/', views.ReadyHealthCheckView.as_view(), name='health_ready'),
    ...
    path('auth/2fa/setup/', views.TwoFactorSetupView.as_view(), name='two_factor_setup'),
