...
class DashboardStatsView(APIView):
    ...
    def get(self, request):
        ...
        if user.role == 'national_leader':
            ...
            stats['pending_approvals'] = User.objects.filter(is_approved=False, is_active=True).count()
            ...
            stats['zones'] = 1
            stats['pending_approvals'] = User.objects.filter(church__in=zone_churches, is_approved=False, is_active=True).count()
            ...
            stats['pending_approvals'] = User.objects.filter(church__in=region_churches, is_approved=False, is_active=True).count()
            ...
            stats['pending_approvals'] = User.objects.filter(church__in=district_churches, is_approved=False, is_active=True).count()
            ...
            stats['pending_approvals'] = User.objects.filter(church=user_church, is_approved=False, is_active=True).count()
...
class RegionListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        user = self.request.user
        if user.role == 'national_leader':
            return Church.objects.filter(church_type='region')
        elif user.role == 'zone_leader':
            return Church.objects.filter(church_type='region', parent_church=user.church)
        elif user.role == 'regional_leader':
            return Church.objects.filter(id=user.church.id)  # Regional leaders see only their region
...
class DistrictListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        user = self.request.user
        if user.role == 'national_leader':
            return Church.objects.filter(church_type='district')
        elif user.role == 'zone_leader':
            return Church.objects.filter(church_type='district', parent_church__parent_church=user.church)
        elif user.role == 'regional_leader':
            return Church.objects.filter(church_type='district', parent_church=user.church)
        elif user.role == 'district_leader':
            return Church.objects.filter(id=user.church.id)  # District leaders see only their district
        return Church.objects.none()
...
class LocalChurchListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        if user.role == 'national_leader':
            ...
            return Church.objects.filter(church_type='local', parent_church__parent_church__parent_church=user.church)
        elif user.role == 'regional_leader':
            return Church.objects.filter(church_type='local', parent_church__parent_church=user.church)
        elif user.role == 'district_leader':
            return Church.objects.filter(church_type='local', parent_church=user.church)
        return Church.objects.filter(id=user.church.id)  # Local leaders see only their church
