...
class MemberRegistrationSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        """Ensure nested info fields are always returned as dicts, never null"""
        data = super().to_representation(instance)
        # Ensure these fields are always dicts, not None
        data['personal_info'] = data.get('personal_info') or {}
        data['guardian_info'] = data.get('guardian_info') or {}
        data['spiritual_info'] = data.get('spiritual_info') or {}
        return data
