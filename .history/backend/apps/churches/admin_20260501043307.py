...
from .models import Church, Zone, Region, District, LocalChurch, ChurchPaymentDetails
...
class ZoneAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'code', 'city', 'phone', 'is_active', 'region_count', 'church_actions')
    ...
    def church_actions(self, obj):
        return format_html('<a class="button" href="/admin/churches/zone/{}/change/">Edit Church Information</a>', obj.id)
    church_actions.short_description = 'Actions'
...
class RegionAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'code', 'parent_zone', 'city', 'is_active', 'district_count', 'church_actions')
    ...
    def church_actions(self, obj):
        return format_html('<a class="button" href="/admin/churches/region/{}/change/">Edit Church Information</a>', obj.id)
    church_actions.short_description = 'Actions'
...
class DistrictAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'code', 'parent_region', 'parent_zone', 'city', 'is_active', 'church_count', 'church_actions')
    ...
    def church_actions(self, obj):
        return format_html('<a class="button" href="/admin/churches/district/{}/change/">Edit Church Information</a>', obj.id)
    church_actions.short_description = 'Actions'
...
class LocalChurchAdmin(admin.ModelAdmin):
    list_display = ('name', 'code', 'parent_district', 'parent_region', 'parent_zone', 'city', 'phone', 'is_active', 'church_actions')
    list_filter = ('is_active', 'parent_church', 'parent_church__parent_church',
    ...
    def church_actions(self, obj):
        return format_html('<a class="button" href="/admin/churches/localchurch/{}/change/">Edit Church Information</a>', obj.id)
    church_actions.short_description = 'Actions'
...
class ChurchAdmin(admin.ModelAdmin):
    """General church management including national and hierarchy records."""
    inlines = [ZoneInline]
    list_display = ('name', 'church_type', 'parent_church', 'is_active', 'city', 'church_actions')
    ...
    def get_inlines(self, request, obj):
        if obj and obj.church_type == 'national':
            return [ZoneInline]
        return []

    def church_actions(self, obj):
        return format_html('<a class="button" href="/admin/churches/church/{}/change/">Edit Church Information</a>', obj.id)
    church_actions.short_description = 'Actions'
...
@admin.register(ChurchPaymentDetails)
class ChurchPaymentDetailsAdmin(admin.ModelAdmin):
    list_display = (
        'church',
        'vodacom_lipa_number',
        'tigo_lipa_number',
    ...
    search_fields = ('church__name', 'bank_account_number', 'vodacom_lipa_number', 'tigo_lipa_number')
    readonly_fields = ('created_at', 'updated_at')
    fieldsets = (
        (None, {'fields': ('church',)}),
        ('Mobile Money', {'fields': ('vodacom_lipa_number', 'tigo_lipa_number', 'airtel_lipa_number', 'halotel_lipa_number')}),
        ('Bank Transfer', {'fields': ('bank_name', 'bank_account_number', 'bank_account_name', 'bank_branch', 'bank_swift_code')}),
