...
class ChurchPaymentDetails(models.Model):
    church = models.OneToOneField(Church, on_delete=models.CASCADE, related_name='payment_details')
    vodacom_lipa_number = models.CharField(max_length=30, default='715001')
    tigo_lipa_number = models.CharField(max_length=30, default='715002')
    airtel_lipa_number = models.CharField(max_length=30, default='715003')
    halotel_lipa_number = models.CharField(max_length=30, default='715004')
    bank_name = models.CharField(max_length=100, default='NMB Bank')
    bank_account_number = models.CharField(max_length=50, default='0150012345678')
    bank_account_name = models.CharField(max_length=255, default='CFCT Church Demo Account')
    bank_branch = models.CharField(max_length=100, blank=True, default='Dar es Salaam Main Branch')
    bank_swift_code = models.CharField(max_length=50, blank=True, default='NMIBTZTZ')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    ...
    def __str__(self):
        return f"Payment Details - {self.church.name}"