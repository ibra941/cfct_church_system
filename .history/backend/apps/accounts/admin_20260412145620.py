...
ROLE_LABEL_MAP = dict(LEADER_ROLE_CHOICES)
...
class AdminUserCreationForm(UserCreationForm):
    ...
    def clean(self):
        ...
        if not church_id:
            ...
            self.add_error('role', f'Please complete hierarchy selection for {role_label}.')
            return cleaned_data
        ...
        if church.church_type != expected_type:
            ...
            self.add_error('role', f'{role_label} requires a {expected_type} selection.')
            return cleaned_data
