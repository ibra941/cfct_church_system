(function () {
  ...
  onReady(function () {
    ...
    var allOptions = Array.prototype.slice.call(churchSelect.options).map(function (opt) {
      return {
        value: opt.value,
        text: opt.text,
    ...
    function rebuildOptions() {
      ...
      if (selectedRole === "national_leader") {
        ...
        var stillExists = Array.prototype.some.call(churchSelect.options, function (opt) {
