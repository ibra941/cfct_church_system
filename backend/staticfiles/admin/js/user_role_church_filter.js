(function () {
  ...
  onReady(function () {
    ...
    var churchRow =
      churchSelect.closest(".form-row") || churchSelect.parentElement;
    var zoneField = createSelectField("Zone", "id_role_zone_filter", churchRow);
    var regionField = createSelectField(
      "Region",
      "id_role_region_filter",
      churchRow,
    );
    var districtField = createSelectField(
      "District",
      "id_role_district_filter",
      churchRow,
    );
